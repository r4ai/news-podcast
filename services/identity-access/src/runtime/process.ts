...
export type IdentityProcessSignal = "SIGINT" | "SIGTERM"

export type IdentityAccessProcessDependencies = Readonly<{
  readonly onceSignal: (
    signal: IdentityProcessSignal,
    listener: () => void
  ) => void
...
export type IdentityAccessProcessController = DeepReadonly<{
  readonly stop: () => void
