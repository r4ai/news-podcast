ALTER TABLE `episode_jobs` ADD `stage_progress_completed` integer;--> statement-breakpoint
ALTER TABLE `episode_jobs` ADD `stage_progress_total` integer;--> statement-breakpoint
