...
export type EpisodeLibraryProcessDependencies = Readonly<{
...
export type EpisodeLibraryProcessController = DeepReadonly<{
  readonly stop: () => void
  readonly completed: Promise<void>
}>

/** Owns OS signals while the Effect program owns SDK and database resources. */
