...
export const telemetryEventNames = [
  ...
  "episode.succeeded",
  "episode.failed",
  "episode.script.quality_evaluated",
...
export const metricNames = [
  ...
  "archive.link_card",
  "archive.assets.attempted",
  "archive.assets.downloaded_bytes",
  "archive.assets.retained_bytes",
  "archive.assets.limit",
  "object.cleanup",
  "provider.request",
  ...
  "article.enrich.daily_reset",
  "article.enrich.attempt",
  "article.enrich.input_rejected",
  "article.search_body.index",
  "article.search_body.queue.depth",
...
export const metricUnits: Readonly<Record<MetricName, string>> = {
  "identity.schedule.suppressed": "{occurrence}",
  ...
  "episode.script.quality": "{evaluation}",
  ...
  "episode.jobs": "{job}",
  "episode.owner.active_jobs": "{job}",
  "episode.owner.queue.oldest.age": "ms",
  "episode.queue.oldest.age": "ms",
  "episode.queue.wait.duration": "ms",
  "episode.stage.oldest.age": "ms",
  "episode.staging.bytes": "By",
  "episode.cleanup.backlog": "{object}",
  "archive.refresh": "{job}",
  "rss.sync.batch": "{job}",
  "rss.sync.duration": "ms",
  "rss.sync.queued_age": "ms",
  "rss.sync.items": "{item}",
  "rss.sync.deferred": "{item}",
  "archive.refresh.wait": "ms",
  "archive.refresh.jobs": "{job}",
  "archive.link_card": "{request}",
  "archive.assets.attempted": "{request}",
  "archive.assets.downloaded_bytes": "By",
  "archive.assets.retained_bytes": "By",
  "archive.assets.limit": "{capture}",
  ...
  "article.enrich.daily_reset": "{reset}",
  "article.enrich.attempt": "{attempt}",
  "article.enrich.input_rejected": "{rejection}",
  "article.search_body.index": "{snapshot}",
  "article.search_body.queue.depth": "{snapshot}",
