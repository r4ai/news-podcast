...
export interface components {
    schemas: {
        ...
        EpisodeJob: {
            ...
            failure?: {
                /**
                 * @description Stable machine-readable Episode generation failure code. Preserve it in logs and traces; clients must use safe copy for unknown future values.
                 * @enum {string}
                 */
